...
namespace App\Controllers\publisher; // Change as per your folder structure
...
class Home extends BaseController
{
	...
	{
		return view('layouts/publisher/client_side/calendar_view');
	}

	public function analytic_view()
	{
		return view('layouts/publisher/client_side/analytic_view');
	}

	public function automation_view()
	{
		return view('layouts/publisher/client_side/rss_feed_view');
	}

	public function bulk_schedule_view()
	{
		return view('layouts/publisher/client_side/bulk_schedule_view');
	}

	public function recycle_view()
	{
		return view('layouts/publisher/client_side/recycle_view');
	}

	public function curate_post_view()
	{
		return view('layouts/publisher/client_side/curate_post_view');
	}

	public function pricing_view()
	{
		return view('layouts/publisher/client_side/pricing_view');
	}
	...
	public function blog_view()
	{
		...
		return view('layouts/publisher/client_side/blog_view', $data);
	}

	public function product_updates()
	{
		$data['blogs'] = $this->Publisher_model->get_allrecords('blogs', array('status' => '1'));
		return view('layouts/publisher/client_side/product_update_view', $data);
	}

	public function login_view()
	{
		if (!$this->Publisher_model->check_logged()) {
			return view('layouts/publisher/client_side/login_view');
		} else {
	...
	{
		if (!$this->Publisher_model->check_logged()) {
			return view('layouts/publisher/client_side/signup_view');
		} else {
			redirect(SITEURL . "dashboard");
		}
	}
	...
	{
		if (!$this->Publisher_model->check_logged()) {
			return view('layouts/publisher/client_side/forgot_password_view');
		} else {
			redirect(SITEURL . "dashboard");
		}
	}
	...
	public function blog_inner_view($slug = null)
	{
		if (!empty($slug) && $slug != 'null') {
			...
			if (count($data['blog']) > 0) {
				return view('layouts/publisher/client_side/blog_inner_view', $data);
			} else {
	...
	{
		return view('layouts/publisher/error_page');
	}
	...
	public function signin()
	{
		if (!$this->Publisher_model->check_logged()) {
			...
			return view('layouts/publisher/signin');
		} else {
	...
	public function dashboard()
	{
		...
		if ($team_role == "affiliate") {
			return view('templates/publisher/header', $roles_data);
			return view('layouts/publisher/affiliate-dashboard', $data);
		} else {
			return view('templates/publisher/header', $roles_data);
			return view('layouts/publisher/owner-dashboard', $data);
		}
	}
	...
	{
		$this->sessioncheck();
		return view('layouts/publisher/settings');
	}
	...
	public function user_error_log()
	{
		...
		return view('templates/publisher/header', $data);
		return view('layouts/publisher/user_error_log');
	}
	...
	public function affiliatemarketing()
	{
		...
		$roles_data['roles'] = $this->Publisher_model->get_active_roles($userID);
		return view('templates/publisher/header', $roles_data);
		return view('layouts/publisher/affiliatemarketing');
	}
	public function affiliatemanage()
	{
		...
		$roles_data['roles'] = $this->Publisher_model->get_active_roles($userID);
		return view('templates/publisher/header', $roles_data);
		return view('layouts/publisher/affiliatemanage');
	}
	public function affiliatemanageppcrates()
	{
		...
		return view('templates/publisher/header', $roles_data);
		return view('layouts/publisher/affiliatemanageppcrates', $data);
	}
	...
	public function paymentsubscriptions()
	{
		...
		if (App::Session()->get('team_role') != 'owner') {
			...
			return view('layouts/publisher/paymentsubscriptions', $data);
		}
	}
	...
	public function thankyou()
	{
		...
		if (App::Session()->get('team_role') != 'owner') {
			...
			return view('layouts/publisher/thankyou');
		}
	}
	...
	public function widgetArea()
	{
		...
		if ($role_status->status == 'InActive') {
			...
			return view('layouts/publisher/widgets', $results);
		}
	}
	...
	public function recycle()
	{
		...
		if ($role_status->status == 'InActive') {
			...
			if ($team_role == 'owner') {
				return view('layouts/publisher/affiliatecampaigns', $data);
			} else {
				return view('layouts/publisher/campaigns', $data);
			}
		}
	}
	public function addcampaign()
	{
		...
		return view('layouts/publisher/affiliateaddcampaign', $data);
	}
	public function affiliateeditcampaign($id)
	{
		...
		return view('templates/publisher/header');
		return view('layouts/publisher/affiliateeditcampaign', $data);
	}
	...
	public function groups()
	{
		...
		return view('layouts/publisher/facebookbulkupload', $data);
	}
	...
	public function schedule()
	{
		...
		if ($status == "" || $status == 'InActive') {
			...
			return view('layouts/publisher/schedule', $data);
		}
	}
	...
	public function automation()
	{
		...
		if ($status == "" || $status == 'InActive') {
			...
			return view('layouts/publisher/automation', $data);
		}
	}
	...
	public function analytics()
	{
		...
		// load analytics view
		return view('layouts/publisher/analytics', $data);
	}

	public function calendar()
	{
		$this->sessioncheck();
		return view('layouts/publisher/calendar');
	}

	public function link_shortener()
	{

		return view('layouts/publisher/client_side/link_shortener_view');
	}
	...
	public function url_tracking()
	{
		...
		$user = $this->Publisher_model->retrieve_record('user', $userID);
		$data["data"]['user'] = $user;
		return view('layouts/publisher/url_tracking', $data);
	}
	...
	public function edit_url($id = null)
	{
		if (!empty($id)) {
			...
			// utms
			$data["data"]['utms'] = $utms;
			return view('layouts/publisher/url_tracking_edit', $data);
		} else {
	...
	public function instagrambulkupload()
	{
		...
		if ($status == "" || $status == 'InActive') {
			...
			return view('layouts/publisher/instagrambulkupload', $data);
		}
	}
	...
	public function instagramstorybulkupload()
	{
		...
		if ($status == "" || $status == 'InActive') {
			...
			$data['user'] = $this->Publisher_model->get_allrecords('user', array('id' => $userID));
			$data['user'] = $data['user'][0];
			return view('layouts/publisher/instagramstorybulkupload', $data);
		}
	}
	public function facebook()
	{
		...
		if ($role_status->status == 'InActive') {
			...
			return view('layouts/publisher/facebook', $data);
		}
	}
	...
	public function paymentmethod()
	{
		...
		if (App::Session()->get('team_role') != 'affiliate') {
			...
			return view('layouts/publisher/payment_method', $data);
			return view('templates/publisher/footer');
		}
	}
	...
	public function changepassword()
	{
		...
		if ($role_status->status == 'InActive') {
			...
			//return view('templates/publisher/header',$roles_data);
			return view('layouts/publisher/changepass');
		}
		return view('templates/publisher/footer');
	}
	public function trafficsummary()
	{
		...
		if ($role_status->status == 'InActive') {
			...
			return view('layouts/publisher/trafficsummary', $data);
		}
	}
	public function earningsummary()
	{
		...
		$this->sessioncheck();
		return view('templates/publisher/header');
		return view('layouts/publisher/earningsummary');
	}
	public function editprofile()
	{
		...
		if ($role_status->status == 'InActive') {
			...
			return view('layouts/publisher/editprofile', $data);
		}
	}
	...
	public function signup()
	{
		if (!$this->Publisher_model->check_logged()) {
			...
			return view('layouts/publisher/signup');
		} else {
	...
	public function annoucement_area()
	{
		...
		$roles_data['roles'] = $this->Publisher_model->get_active_roles($userID);
		return view('templates/publisher/header', $roles_data);
		return view('layouts/publisher/annoucement_area', $data);
	}
	...
	public function notifications_area()
	{
		...
		$roles_data['roles'] = $this->Publisher_model->get_active_roles($userID);
		return view('templates/publisher/header', $roles_data);
		return view('layouts/publisher/notifications_area', $data);
	}
	...
	public function create_article()
	{
		...
		$data['categories'] = $this->Publisher_model->list_records('link_cat', 0, 1000);
		return view('templates/publisher/header', $roles_data);
		return view('layouts/publisher/createarticle', $data);
	}
	...
	public function manage_article()
	{
		...
		$roles_data['roles'] = $this->Publisher_model->get_active_roles($userID);
		return view('templates/publisher/header', $roles_data);
		return view('layouts/publisher/manage_article', $data);
	}
	...
	public function edit_article($article_id)
	{
		...
		$roles_data['roles'] = $this->Publisher_model->get_active_roles($userID);
		return view('templates/publisher/header', $roles_data);
		return view('layouts/publisher/edit_article', $data);
	}
	...
	public function preview_article($article_id)
	{
		...
		$roles_data['roles'] = $this->Publisher_model->get_active_roles($userID);
		return view('templates/publisher/header', $roles_data);
		return view('layouts/publisher/preview_article', $data);
	}

	function terms()
	{

		return view('layouts/publisher/terms');
	}

	function privacy()
	{

		return view('layouts/publisher/privacy');
	}

	function termsfb()
	{

		return view('layouts/publisher/termsfb');
	}

	public function forgot()
	{

		return view('layouts/publisher/forgotpass');
	}
	...
	public function socialaccounts()
	{
		...
		if ($status == "" || $status == 'InActive') {
			...
			return view('layouts/publisher/social_accounts', $data);
		}
	}
	...
	public function youtube()
	{
		...
		return view('layouts/publisher/youtube', $data);
	}
}
