...
<head>
    ...
    $this->load->view("layouts/publisher/views/profile/style");
    ?>
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-xlg-12">
                            <div class="card">
                                <div class="card-body">
                                    <?php $this->load->view("layouts/publisher/views/profile/index", $data) ?>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    $this->load->view("layouts/publisher/views/profile/script");
    ?>
</body>
