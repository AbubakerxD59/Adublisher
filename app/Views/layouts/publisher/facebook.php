...
$dt = new DateTime('2016-12-12 12:12:12', new DateTimeZone('Asia/Karachi'));
          ...
          <div class="card-body">
            ...
            <div class="row p-10 m-0">
              ...
              if ($account == '1') {
                ...
                ?>
                  <div class="col-md-12">
                    <!-- <div class="card" style="background: url(<?= GeneralAssets ?>images/fb_bg.jpg);background-size: cover;">
                    <div class="card-body">
                        <div class="d-flex flex-row">
                            <div class=""><img src="<?php echo $user->facebook_dp; ?>" alt="user" class="rounded" width="100" /></div>
                            <div class="p-l-20">
                                <h3 class="font-medium text-white"><?php echo $user->facebook_name; ?></h3>
                                <h6 class="text-white"><?php echo $user->facebook_email; ?></h6>
                                <button class="btn btn-success"><i class="ti-facebook"></i> <?php echo $user->facebook_id; ?></button>
                            </div>
                        </div>
                    </div>
                </div>  -->
                    ...
                    ?>
                      <div class="card earning-widget">
                        <div class="card-body row m-b-0 m-t-10 ">
                          <div class="col-md-6 ">
                            <!-- <h4 class="card-title m-l-15">Your Facebook Pages (<?php echo count($user_pages); ?>)
                                   </h4> -->
                            <h6 class="card-subtitle pull-left m-r-20" style="">
                              <!-- 
                                       <b>
                                        <i class="mdi mdi-help-circle-outline bold"  data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Select active hours for your pages, so you can get posts between those hours. This Change will reflect your posting very next day."></i>
                                          </b>
                                        &nbsp;<button class="btn btn-outline-secondary btn-sm" data-toggle="modal" data-target="#active-hours" data-id="<?php echo $user->id; ?>" ><span class="fa fa-unlink"></span> Set Posting Hours </button>
                                      -->
                              <a href="<?php echo $this->facebook->addpage_url(); ?>" class="btn btn-outline-secondary btn-sm"> <i class="fa fa-plus"></i> Add Facebook page </a>
                            </h6>
                          </div>
                          <div class="col-md-6 ">
                            <h6 class="text-muted pull-right m-r-20" style=""> Want to disconnect all pages ? &nbsp;<button class="btn btn-outline-danger btn-sm" data-toggle="modal" data-target="#confirm-delete" data-id="<?php echo $user->id; ?>"><span class="fa fa-unlink"></span> click here </button></h6>
                          </div>
                        </div>
                        ...
                        <div class="card-body b-t">
                          <table class="tablesaw table-bordered table-hover table" data-tablesaw-mode="columntoggle" data-tablesaw-sortable data-tablesaw-sortable-switch data-tablesaw-minimap data-tablesaw-mode-switch>
                            ...
                            <tbody>
                              ...
                              ?>
                                <tr class="">
                                  <td class="title"> <img style="width:50px;height:50px;" src="<?= GeneralAssets ?>images/facebook_logo.png" class="rounded" alt="profile_pic"> <b><?php echo $page['page_name']; ?></b></td>
                                  ...
                                  <td class="text-center">
                                    <button class="btn btn-outline-danger btn-sm deletepage " id="delete_<?= $page['id'] ?>" data-src="<?= $page['image_url'] ?>" data-toggle="modal" data-target="#confirm-remove" data-name="<?= $page['page_name'] ?>" data-id="<?= $page['id'] ?>"><span class="icon-trash"></span> Remove
                                    </button>
                                  </td>
                                </tr>
                              <?php
            ...
            <div class="modal fade" id="confirm-remove" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <p class="text-center"> <img style="width:120px;height:120px;" id="caution_image" src="<?= GeneralAssets ?>images/facebook_logo.png" class="rounded b-all" alt="image">
                      <br>
                      <b><i class="title">Page</i></b>
                    </p class="text-center">
                    <p>You are about to Remove <span class="title"></span> page From, Adublisher.com
                      You will no longer get posts on this page / All Scedule Posts will be removed.
                      You Can Re-Connect Your Facebook account to get this page here</p>
                  </div>
                  <div class="modal-footer">
          ...
          <script type="text/javascript">
            $(document).ready(function() {
              swal({
                ...
                text: "Dear, <?= $user->facebook_name . " Your Facebook Account is Successfully Attached With Adublisher.com"; ?>",
        ...
        $(document).ready(function() {
          ...
          $(".chosen-timeslots").change(function() {
            ...
            if (page != "") {
              ...
              $.ajax({
                type: "POST",
                url: "<?php echo SITEURL; ?>update_page_timeslots_auto",
                data: dataOBJ,
                dataType: "json",
          ...
          $(document).on('change', '.autoposting', function() {
            ...
            $.ajax({
              type: "POST",
              url: "<?php echo SITEURL; ?>updatepageautopost",
              data: dataOBJ,
              dataType: "json",
              success: function(response) {
                if (response.status) {
          ...
          $('#confirm-remove').on('click', '.btn-ok', function(e) {
            ...
            $.ajax({
              type: "POST",
              url: "<?php echo SITEURL; ?>disconnectfacebookpage",
              data: dataOBJ,
              dataType: "json",
              success: function(response) {
                if (response.status) {
