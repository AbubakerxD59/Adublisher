     ...
     <div class="container pt-5 my-48">
         <div class="col-12 justify-content-center text-center">
             <div class="text-wrapper center">
                 ...
                 <p>
                     Go beyond likes and follows. Adublisher Analytics equips you with in-depth performance insights
                     to fuel smarter
                     <br class="d-none d-lg-flex">
                     social decisions. Track progress, identify trends, and dominate your social space with
                     confidence.
                 </p>
             ...
             <div class="col-12 col-lg-6 pxr-24">
                 <div class="text-wrapper featured-text">
                     ...
                     <p>
                         ...
                         gathered from all social media networks, into clear actionable insights needed to develop
                         and ace your social media game.
                     </p>
                     <p>
             ...
             <div class="col-12 col-lg-6 pxl-24">
                 <div class="featured-images">
                     <img class="img-fluid w-100 h-100" alt="Featured Image about Calender"
                         src="<?php echo ASSETURL . 'images/Features/Analytics-Insights.jpg'; ?>">
                 </div>
             </div>
         </div>
     </div>
         ...
         <div class="row reverse g-4 align-items-center mx-auto px-auto">
             <div class="col-12 col-lg-6 pxl-24">
                 <div class="text-wrapper featured-text">
                     ...
                     <p>
                         Personalize your post insights with metrics you want to see first. Customize the data
                         columns and sort all your posts based on their performance.
                     </p>
                     <p>
                         Filter your data by social accounts, time period, or Workspace members to know exactly what
                         is working, and measure performance.
                     </p>
                     <p>
                         And if you want to dive deeper, click on the post to get a full view and learn more about
                         its individual metrics, activity, and progress.
                     </p>
                 </div>
             </div>
             <div class="col-12 col-lg-6 pxr-24">
                 <div class="featured-images">
                     <img class="img-fluid w-100 h-100" alt="Link in Bio illustration Image"
                         src="<?php echo ASSETURL . 'images/Features/Analytics-Mediametrics.webp'; ?>">
                 </div>
             </div>
         </div>
     </div>
     ...
     <div class="container py-24 my-5">
         <div class="col-12">
             <div class="text-wrapper center">
                 ...
                 <p class="description">
                     Tired of guessing what and when to post? Adublisher’s internal algorithm and AI predict peak
                     engagement times for
                     each social media platform, based on your unique activity and audience. Maximize reach,
                     engagement, and ROI
         ...
         <div class="col-12 mt-5">
             <div class="container img-container-center">
                 <img src="<?php echo ASSETURL . 'images/Time.png'; ?>" class="h-100 w-100">
             </div>
         </div>
     </div>
 </div>
 ...
 <div class="container-fluid bg-light-white">
     ...
     <div class="container py-24">
         <div class="row g-4 align-items-center mx-auto px-auto">
                 ...
                 <div class="text-wrapper featured-text">
                     ...
                     <ul class="feature-lister">
                         <li>
                             ...
                             <b>Reach Rate:</b>What social media networks don't want you to know: Understand your
                             post reach - relative to your account's followers.
                         </li>
                         <li>
                             <i class='bx bx-check'></i>
                         ...
                         <li>
                             <i class='bx bx-check'></i>
                             <b>Click-Through Rate:</b>Track link clicks for posts or Link in Bio, understand what
                             drives results & maximize ROI.
                         </li>
                     </ul>
                 </div>
             </div>
             <div class="col-12 col-lg-6 pxl-24">
                 <div class="featured-images">
                     <img class="img-fluid w-100 h-100" alt="About Workspaces in Adublishers"
                         src="<?php echo ASSETURL . 'images/Features/Analytics-Keymetrics.jpg'; ?>">
                 </div>
             </div>
         </div>
     </div>
         ...
         <div class="row reverse g-4 align-items-center mx-auto px-auto">
             <div class="col-12 col-lg-6 pxl-24">
                 <div class="text-wrapper featured-text">
                     ...
                     <p>
                         Understand your social media audience like never before! Gain valuable insights into who
                         engages with your content, including:
                     </p>
                     <ul class="feature-lister">
                         <li>
                             <i class='bx bx-check'></i>
             ...
             <div class="col-12 col-lg-6 pxr-24">
                 <div class="featured-images">
                     <img class="img-fluid w-100 h-100" alt="Analytics illustration Image of Adublisher"
                         src="<?php echo ASSETURL . 'images/Features/Analytics-Demographicinsights.jpg'; ?>">
                 </div>
             </div>
         </div>
     </div>
         ...
         <div class="row g-4 align-items-center mx-auto px-auto">
             <div class="col-12 col-lg-6 pxr-24">
                 <div class="text-wrapper featured-text">
                     ...
                     <p>
                         Gain in-depth insights of the hashtags you use. Hashtag Analysis provides a clear picture of
                         how your hashtags perform across platforms and posts, empowering you to optimize your
                         strategy based on real results.
                     </p>
                     <p>
             ...
             <div class="col-12 col-lg-6 pxl-24">
                 <div class="featured-images">
                     <img class="img-fluid w-100 h-100" alt="Featured Image about Calender"
                         src="<?php echo ASSETURL . 'images/Features/Analytics-Hashtag.jpg'; ?>">
                 </div>
             </div>
         </div>
     </div>
         ...
         <div class="row reverse g-4 align-items-center mx-auto px-auto">
             <div class="col-12 col-lg-6 pxl-24">
                 <div class="text-wrapper featured-text">
                     ...
                     <p>
                         <b>Analyze key competitor metrics: </b> Track follower growth, engagement rates, and the
                         content types that resonate most with your competitor’s audience.
                     </p>
                     <p>
                     ...
                     <p>
                         <b>Optimize your posting schedule:</b> By analyzing when your competitors are most active
                         and generating engagement, Adublisher can refine your posting schedule to better reach your
                         target audience.
                     </p>
                 </div>
             </div>
             <div class="col-12 col-lg-6 pxr-24">
                 <div class="featured-images">
                     <img class="img-fluid w-100 h-100" alt="Featured Image about Calender"
                         src="<?php echo ASSETURL . 'images/Features/Analtyics-Outsmart.jpg'; ?>">
                 </div>
             </div>
         </div>
     </div>
     ...
     <div class="container py-24">
         <div class="row g-4 align-items-center mx-auto px-auto">
             ...
             <div class="col-12 col-lg-6 pxl-24">
                 <div class="featured-images">
                     <img class="img-fluid w-100 h-100" alt="Featured Image about Calender"
                         src="<?php echo ASSETURL . 'images/Features/Analytics-PDF&CSV.jpg'; ?>">
                 </div>
             </div>
         </div>
     </div>
     ...
     <div class="container py-24 my-5 text-center justify-content-center">
         <div class="row">
             <div class="col-12">
                 <div class="text-wrapper center">
                     <h2>
                         Adublisher Analytics on Your Smartphone
                     </h2>
                     <p class="description">
                         Stay in control even on the move! Adublisher Analytics brings all desktop insights into your
                         pocket through the
                         <br class="d-none d-lg-block">
                         Adublisher App. Track performance, export reports, and manage data – just like you would on
                         your computer.
                     </p>
             ...
             <div class="col-12 mt-5">
                 <div class="container img-container-center">
                     <img src="<?php echo ASSETURL . 'images/Mobile Analytics.png'; ?>" class="h-100 w-100">
                 </div>
             </div>
         </div>
     </div>
