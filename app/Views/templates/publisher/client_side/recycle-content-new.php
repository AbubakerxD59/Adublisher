         ...
         <div class="row align-items-center">
             <div class="col-12 col-lg-6">
                 <div class="text-wrapper featured-text">
                     ...
                     <p>
                         Bring attention to your top-performing posts and drive brand awareness simply by recycling. Manage the frequency, start/end date, and keep an eye on your virtual recycle.
                     </p>
                     <p>
             ...
             <div class="col-12 col-lg-6 my-5">
                 <div class="banner-illustration-image">
                     <img src="<?php echo ASSETURL . 'images/Recycle-Illustration.png'; ?>" class="w-100">
                 </div>
             </div>
         </div>
     </div>
 ...
 <div class="container-fluid bg-light-white">
         ...
         <div class="row g-4 align-items-center mx-auto px-auto">
             ...
             <div class="col-12 col-lg-6 pxl-24">
                 <div class="featured-images">
                     <img class="w-100 h-100" alt="Featured Image about Calender" src="<?php echo ASSETURL . 'images/Features/Recycle-Content.jpg'; ?>">
                 </div>
             </div>
         </div>
     </div>
     ...
     <div class="container py-24">
         <div class="row reverse g-4 align-items-center mx-auto px-auto">
             ...
             <div class="col-12 col-lg-6 pxr-24">
                 <div class="featured-images">
                     <img class="w-100 h-100" alt="Link in Bio illustration Image" src="<?php echo ASSETURL . 'images/Features/Recycle-Post.jpg'; ?>">
                 </div>
             </div>
         </div>
     </div>
 ...
 <div class="container-fluid bg-light-white">
     <div class="container py-24">
         ...
         <div class="row g-4 align-items-center mx-auto px-auto">
             ...
             <div class="col-12 col-lg-6 pxl-24">
                 <div class="featured-images">
                     <img class="w-100 h-100" alt="About Workspaces in Adublishers" src="<?php echo ASSETURL . 'images/Features/Recycle-Recurring.jpg'; ?>">
                 </div>
             </div>
         </div>
     </div>
         ...
         <div class="row reverse g-4 align-items-center mx-auto px-auto">
             <div class="col-12 col-lg-6 pxl-24">
                 <div class="text-wrapper featured-text">
                     ...
                     <p>
                         Adublisher proudly integrates with the Spintax generator, which allows every user to prepare tons of content in less time than you can imagine.
                     </p>
                     <p>
             ...
             <div class="col-12 col-lg-6 pxr-24">
                 <div class="featured-images">
                     <img class="img-fluid w-100 h-100" alt="Analytics illustration Image of Adublisher" src="<?php echo ASSETURL . 'images/Features/Recycle-Spintax.jpg'; ?>">
                 </div>
             </div>
         </div>
     </div>
