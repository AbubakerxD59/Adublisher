          ...
          <div class="row align-items-center">
              ...
              <div class="col-12 col-lg-6 my-5">
                  <div class="banner-illustration-image">
                      <img src="<?php echo ASSETURL . 'images/Calendar_View.png'; ?>" class="w-100">
                  </div>
              </div>
          </div>
      </div>
  ...
  <div class="container-fluid bg-light-white">
          ...
          <div class="row g-4 align-items-center mx-auto px-auto">
              <div class="col-12 col-lg-6 pxr-24">
                  <div class="featured-images">
                      <img class="w-100 h-100" alt="Featured Image about Calender" src="<?php echo ASSETURL . 'images/Features/Calendar-Manage.jpg'; ?>">
                  </div>
              </div>
              <div class="col-12 col-lg-6 pxl-24">
                  <div class="text-wrapper featured-text">
                      ...
                      <p>
                          Adublisher’s virtual calendar simplifies your work management. Posts will display on the calendar with their respective icons (draft, manually scheduled,
      ...
      <div class="container py-24">
          <div class="row reverse g-4 align-items-center mx-auto px-auto">
              <div class="col-12 col-lg-6 pxl-24">
                  <div class="featured-images">
                      <img class="w-100 h-100" alt="Link in Bio illustration Image" src="<?php echo ASSETURL . 'images/Features/Calendar-Filter.jpg'; ?>">
                  </div>
              </div>
              <div class="col-12 col-lg-6 pxr-24">
                  <div class="text-wrapper featured-text">
                      ...
                      <p>
                          Don’t let yourself get distracted by a jungle of posts your members and you have prepared for the following months. If you want to focus solely on a few upcoming posts, Adublisher gives you filter options for organizing, categorizing, and prioritizing your work.
                      </p>
      ...
      <div class="container py-24 my-5 text-center justify-content-center">
          <div class="col-12">
              <div class="text-wrapper center">
                  ...
                  <p class="description">
                      Keeping content fresh and creative is key. To make things easier for you, we've created a visual calendar with
          ...
          <div class="col-12 mt-5">
              <div class="container img-container-center">
                  <img src="<?php echo ASSETURL . 'images/Holiday.png'; ?>" class="h-100 w-100">
              </div>
          </div>
      </div>
  </div>
  ...
  <div class="container-fluid bg-light-white">
      <div class="container py-24">
          ...
          <div class="row g-4 align-items-center mx-auto px-auto">
              <div class="col-12 col-lg-6 pxr-24">
                  <div class="featured-images">
                      <img class="w-100 h-100" alt="About Workspaces in Adublishers" src="<?php echo ASSETURL . 'images/Features/Calendar-Predict.jpg'; ?>">
                  </div>
              </div>
              <div class="col-12 col-lg-6 pxl-24">
                  <div class="text-wrapper featured-text">
      ...
      <div class="container py-24">
          ...
          <div class="row reverse g-4 align-items-center mx-auto px-auto">
              <div class="col-12 col-lg-6 pxl-24">
                  <div class="featured-images">
                      <img class="img-fluid w-100 h-100" alt="Analytics illustration Image of Adublisher" src="<?php echo ASSETURL . 'images/Features/Calendar-Time.jpg'; ?>">
                  </div>
              </div>
              <div class="col-12 col-lg-6 pxr-24">
                  <div class="text-wrapper featured-text">
                      ...
                      <p>
                          Adublisher makes it easier to boost engagement, improve ROI, and run your business better - by displaying the best times to post.
                      </p>
                      <p>
      ...
      <div class="container py-24 my-5 text-center justify-content-center">
          <div class="col-12">
              <div class="text-wrapper center">
                  ...
                  <p class="description">
                      Refine an aesthetic Instagram feed by planning out visuals one by one or in bulk. Import or design brand new marketing
                      <br class="d-none d-lg-block">
          ...
          <div class="col-12 mt-5">
              <div class="container img-container-center">
                  <img src="<?php echo ASSETURL . 'images/Android.png'; ?>" class="h-100 w-100">
              </div>
          </div>
      </div>
  </div>
