         ...
         <div class="row align-items-center">
             ...
             <div class="col-12 col-lg-6 my-5">
                 <div class="banner-illustration-image">
                     <img src="<?php echo ASSETURL . 'images/BioLink.svg'; ?>" class="w-100">
                 </div>
             </div>
         </div>
     </div>
 ...
 <div class="container-fluid bg-light-white">
         ...
         <div class="row g-4 align-items-center mx-auto px-auto">
             <div class="col-12 col-lg-6 pxr-24">
                 <div class="text-wrapper featured-text">
                     ...
                     <p>
                         With Adublisher, you can sync old posts and pull/filter real-time updates from all your favorite websites.
                     </p>
                     <p>
             ...
             <div class="col-12 col-lg-6 pxl-24">
                 <div class="featured-images">
                     <img class="w-100 h-100" alt="Featured Image about Calender" src="<?php echo ASSETURL . 'images/Features/RSS-Feeds.jpg'; ?>">
                 </div>
             </div>
         </div>
     </div>
     ...
     <div class="container py-24">
         <div class="row reverse g-4 align-items-center mx-auto px-auto">
             ...
             <div class="col-12 col-lg-6 pxr-24">
                 <div class="featured-images">
                     <img class="w-100 h-100" alt="Link in Bio illustration Image" src="<?php echo ASSETURL . 'images/Features/RSS-Automate.jpg'; ?>">
                 </div>
             </div>
         </div>
     </div>
         ...
         <div class="row">
             <div class="col-12 col-lg-4">
                 <div class="review-container left">
                     ...
                     <h3>Wordpress</h3>
                     <p>
                         Add a ‘/feed’ at the end of the URL. Like this: 'adublisher.io/blog/feed'
                     </p>
                 </div>
             </div>
             <div class="col-12 col-lg-4">
 ...
 <div class="container-fluid bg-light-white">
         ...
         <div class="row g-4 align-items-center mx-auto px-auto">
             <div class="col-12 col-lg-6 pxr-24">
                 <div class="text-wrapper featured-text">
                     ...
                     <p>
                         After finding the correct RSS Feed URL, it’s time to add it to Adublisher and set all the settings up.
                     </p>
                     <p>
             ...
             <div class="col-12 col-lg-6 pxl-24">
                 <div class="featured-images">
                     <img class="w-100 h-100" alt="About Workspaces in Adublishers" src="<?php echo ASSETURL . 'images/Features/RSS-URL.jpg'; ?>">
                 </div>
             </div>
         </div>
     </div>
     <div class="container py-24">
         ...
         <div class="row reverse g-4 align-items-center mx-auto px-auto">
             <div class="col-12 col-lg-6 pxl-24">
                 <div class="text-wrapper featured-text">
                     ...
                     <ul class="feature-lister">
                         ...
                         <li>
                             <i class='bx bx-check'></i>
                             <b>Auto Post</b>: Every new item that is published will be automatically posted across social accounts that you select.
                         </li>
                         <li>
                             <i class='bx bx-check'></i>
                             <b>Auto Schedule</b>: Every new item that is published will be automatically scheduled according to a specific posting schedule you decide.
                         </li>
                     </ul>
                     <p>
             ...
             <div class="col-12 col-lg-6 pxr-24">
                 <div class="featured-images">
                     <img class="img-fluid w-100 h-100" alt="Analytics illustration Image of Adublisher" src="<?php echo ASSETURL . 'images/Features/RSS-URLManage.jpg'; ?>">
                 </div>
             </div>
         </div>
     </div>
         ...
         <div class="row">
             ...
             <div class="col-12 mt-5">
                 <div class="container img-container-center">
                     <img src="<?php echo ASSETURL . 'images/Extra-Tool.svg'; ?>" class="h-100 w-100">
                 </div>
             </div>
         </div>
     </div>
