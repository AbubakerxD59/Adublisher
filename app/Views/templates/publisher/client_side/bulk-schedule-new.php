     ...
     <div class="container pt-5 my-48">
         ...
         <div class="col-12">
             <div class="container img-container-center">
                 <img src="<?php echo ASSETURL . 'images/Bulk-Scheduling.png'; ?>" class="h-100 w-100">
             </div>
         </div>
     </div>
 </div>
             ...
             <div class="col-12 col-lg-6 pxl-24">
                 <div class="featured-images">
                     <img class="img-fluid w-100 h-100" alt="Featured Image about Calender"
                         src="<?php echo ASSETURL . 'images/Features/Bulk-Benefits.jpg'; ?>">
                 </div>
             </div>
         </div>
     </div>
         ...
         <div class="row g-4 align-items-center mx-auto px-auto">
             <div class="col-12 col-lg-6 pxr-24">
                 <div class="text-wrapper featured-text">
                     ...
                     <p>
                         We know that when creativity hits, you have to write everything down! That’s why you can
                         create new posts on the editor and manage them individually.
                     </p>
                     <p>
             ...
             <div class="col-12 col-lg-6 pxl-24">
                 <div class="featured-images">
                     <img class="img-fluid w-100 h-100" alt="Featured Image about Calender"
                         src="<?php echo ASSETURL . 'images/Features/Bulk-Add.jpg'; ?>">
                 </div>
             </div>
         </div>
     </div>
         ...
         <div class="row reverse align-items-center mx-auto px-auto">
             <div class="col-12 col-lg-6 pxl-24">
                 <div class="text-wrapper featured-text">
                     ...
                     <p>
                         Easily upload media files from Google Drive, Dropbox, OneDrive, Unsplash, external URLs, or
                         your device.
                     </p>
                 </div>
             </div>
             <div class="col-12 col-lg-6 pxr-24 ">
                 <div class="featured-images">
                     <img class="img-fluid w-100 h-100" alt="Link in Bio illustration Image"
                         src="<?php echo ASSETURL . 'images/Features/Bulk-Upload.jpg'; ?>">
                 </div>
             </div>
         </div>
     </div>
         ...
         <div class="row align-items-center mx-auto px-auto">
             <div class="col-12 col-lg-6 pxr-24">
                 <div class="text-wrapper featured-text">
                     ...
                     <p>
                         Being account-specific, CSVs are a fast way to populate your calendar and stay active on
                         your favorite social networks.
                     </p>
                     <p>
                         You can add descriptions, links and media. CSV upload is an extremely powerful tool that
                         will allow you to stay on top of your social media content.
                     </p>
             ...
             <div class="col-12 col-lg-6 pxl-24 ">
                 <div class="featured-images">
                     <img class="img-fluid w-100 h-100" alt="Link in Bio illustration Image"
                         src="<?php echo ASSETURL . 'images/FilterExtension.jpg'; ?>">
                 </div>
             </div>
         </div>
     </div>
     ...
     <div class="container justify-content-center text-center py-5 my-5">
         <div class="col-12">
             <div class="text-wrapper center">
                 ...
                 <p class="description">
                     The ability to modify and update each post individually within the same dashboard is a
                     no-brainer!
                     <br class="d-none d-lg-block">
         ...
         <div class="reverse row align-items-center mx-auto px-auto">
             <div class="col-12 col-lg-6 pxl-24">
                 <div class="text-wrapper featured-text">
                     ...
                     <p>
                         Adublisher offers 4 scheduling options for you to choose from:
                     </p>
                     <ul class="feature-lister">
                         <li>
                             <i class='bx bx-check'></i>
             ...
             <div class="col-12 col-lg-6 pxr-24 ">
                 <div class="featured-images">
                     <img class="img-fluid w-100 h-100" alt="Link in Bio illustration Image"
                         src="<?php echo ASSETURL . 'images/Features/Bulk-Scheduling.jpg'; ?>">
                 </div>
             </div>
         </div>
     </div>
         ...
         <div class="row align-items-center mx-auto px-auto">
             <div class="col-12 col-lg-6 pxr-24">
                 <div class="text-wrapper featured-text">
                     ...
                     <p>
                         We know it’s all fun and games until you realize that your posts look way too basic and
                         don’t deliver the right message you initially wanted.
                     </p>
                     <p>
                         Therefore, Adublisher helps curate each post individually by allowing you to add the right
                         location and reach even more people in your local area; add general information as
                         signatures; keep the content clean by putting extra content as follow-up comments;
                         auto-share across other socials; and automate the deletion of a post after a specific time.
                     </p>
                 </div>
             </div>
             <div class="col-12 col-lg-6 pxl-24">
                 <div class="featured-images">
                     <img class="img-fluid w-100 h-100" alt="About Workspaces in Adublishers"
                         src="<?php echo ASSETURL . 'images/Features/Bulk-Tools.jpg'; ?>">
                 </div>
             </div>
         </div>
     </div>
     ...
     <div class="container py-24 my-5 text-center justify-content-center">
         <div class="row">
             ...
             <div class="col-12 mt-5">
                 <div class="container img-container-center">
                     <img src="<?php echo ASSETURL . 'images/Features/Bulk-Superpowertools.png'; ?>" class="h-100 w-100">
                 </div>
             </div>
         </div>
     </div>
