     ...
     <div class="container pt-5 my-48">
         <div class="col-12 justify-content-center text-center">
             <div class="text-wrapper center">
                 ...
                 <p>
                     Develop a strategic social media marketing plan by utilizing all the features that Adublisher
                     provides.
                     <br class="d-none d-lg-block">
                     Personalize your online presence by carefully curating your posts: format the text, preview
                     posts, and save time.
                 </p>
                 <a href="<?php echo SITEURL . 'register'; ?>" class="btn btn-colored">Create Account</a>
             </div>
         </div>
         <div class="col-12">
             <div class="container img-container-center">
                 <img src="<?php echo ASSETURL . 'images/curateposts.jpg'; ?>" class="h-100 w-100">
             </div>
         </div>
     </div>
 </div>
         ...
         <div class="row g-4 align-items-center mx-auto px-auto">
             <div class="col-12 col-lg-6 pxr-24">
                 <div class="text-wrapper featured-text">
                     ...
                     <p>
                         Build a content marketing strategy by discovering all our helpful and intuitive built-in
                         tools.
                     </p>
             ...
             <div class="col-12 col-lg-6 pxl-24">
                 <div class="featured-images">
                     <img class="img-fluid w-100 h-100" alt="Featured Image about Calender"
                         src="<?php echo ASSETURL . 'images/Features/Curate-Text.jpg'; ?>">
                 </div>
             </div>
         </div>
     </div>
             ...
             <div class="col-12 col-lg-6 pxl-24">
                 <div class="text-wrapper featured-text">
                     ...
                     <ul class="feature-lister">
                         <li>
                             <i class='bx bx-check'></i>
                             Import media from Drive, Dropbox, OneDrive, Unsplash, Media Library, external URLs, or
                             your local storage.
                         </li>
                         <li>
                             <i class='bx bx-check'></i>
                             Design unique photo illustrations with Canva on Adublisher using the built-in button
                             with a dedicated dashboard and all features that your plan allows.
                         </li>
                         <li>
                             <i class='bx bx-check'></i>
                             Create visually attractive marketing videos with VistaCreate using some of the Pro
             ...
             <div class="col-12 col-lg-6 pxr-24">
                 <div class="featured-images">
                     <img class="img-fluid w-100 h-100" alt="Link in Bio illustration Image"
                         src="<?php echo ASSETURL . 'images/Features/Curate-Visuals.jpg'; ?>">
                 </div>
             </div>
         </div>
     </div>
     ...
     <div class="container py-24 my-5 text-center justify-content-center">
         <div class="row">
             <div class="col-12">
                 <div class="text-wrapper center">
                     ...
                     <p class="description">
                         ...
                         <br class="d-none d-lg-block">
                         visual content differently too—photos on Instagram will look different than they do on
                         Facebook or Twitter.
                         <br class="d-none d-lg-block">
                         Creating similar, but not identical content for each platform is essential for high
                         engagement
                     </p>
                 </div>
             </div>
             <div class="col-12 mt-5">
                 <div class="container img-container-center">
                     <img src="<?php echo ASSETURL . 'images/Features/Curate-Customize.jpg'; ?>" class="h-100 w-100">
                 </div>
             </div>
         </div>
     </div>
         ...
         <div class="row g-4 align-items-center mx-auto px-auto">
             <div class="col-12 col-lg-6 pxr-24">
                 <div class="text-wrapper featured-text">
                     ...
                     <p>
                         With our Preview Posts feature, you can spot and avoid any typos before they go live. We’ve
                         all been there.
                     </p>
                 </div>
             </div>
             <div class="col-12 col-lg-6 pxl-24">
                 <div class="featured-images">
                     <img class="img-fluid w-100 h-100" alt="About Workspaces in Adublishers"
                         src="<?php echo ASSETURL . 'images/Features/Curate-Preview.jpg'; ?>">
                 </div>
             </div>
         </div>
     </div>
         ...
         <div class="row reverse align-items-center mx-auto px-auto">
             <div class="col-12 col-lg-6 pxl-24">
                 <div class="text-wrapper featured-text">
                     ...
                     <p>
                         Adublisher’s composer is part of an intuitive dashboard, where you can create unique posts
                         effortlessly.
                     </p>
                     <p>
                         Each post can be individually modified by using the corresponding content, links, and
                         visuals. Besides that, you can pick a different scheduling method for each of the posts:
                         manually, adding the time and date; automatically, using a specific time slot; recycling and
                         recurring.
                     </p>
                 </div>
             </div>
             <div class="col-12 col-lg-6 pxr-24">
                 <div class="featured-images">
                     <img class="img-fluid w-100 h-100" alt="Analytics illustration Image of Adublisher"
                         src="<?php echo ASSETURL . 'images/Features/Curate-MultiplePosts.jpg'; ?>">
                 </div>
             </div>
         </div>
     </div>
             ...
             <div class="col-12 col-lg-6 pxr-24">
                 <div class="text-wrapper featured-text">
                     ...
                     <ul class="feature-lister">
                         ...
                         <li>
                             <i class='bx bx-check'></i>
                             Resize, filter, and add visual elements to your photo and instantly schedule the design
                             to all your social accounts in Adublisher.
                         </li>
                         <li>
                             <i class='bx bx-check'></i>
             ...
             <div class="col-12 col-lg-6 pxl-24">
                 <div class="featured-images">
                     <img class="w-100 h-100" alt="Featured Image about Calender"
                         src="<?php echo ASSETURL . 'images/Features/Curate-PhotoEditor.jpg'; ?>">
                 </div>
             </div>
         </div>
     </div>
