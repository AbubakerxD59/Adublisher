...
<input type="image" src="<?php echo SITEURLMM;?>/gateways/skrill/logo_large.png" style="width:150px" name="submit" class="wojo basic primary button" title="Pay With Skrill" alt="" onclick="document.mb_form.submit();">
  <input type="hidden" name="pay_to_email" value="<?php echo $this->gateway->extra;?>">
  <input type="hidden" name="return_url" value="<?php echo SITEURL.'thankyou'; ?>">
  <input type="hidden" name="cancel_url" value="<?php echo SITEURL; ?>">
  <input type="hidden" name="status_url" value="<?php echo SITEURLMM.'/gateways/' . $this->gateway->dir;?>/ipn.php" />
