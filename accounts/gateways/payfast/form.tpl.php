...
<?php $url = ($this->gateway->live) ? 'www.payfast.co.za' : 'sandbox.payfast.co.za';?>
  <form action="https://<?php echo $url;?>/eng/process" class="center aligned" method="post" id="pf_form" name="pf_form">
    <input type="image" src="<?php echo SITEURLMM.'/gateways/payfast/logo_large.png';?>" style="width:150px" class="wojo basic primary button" name="submit" title="Pay With PayFast" alt="" onclick="document.pf_form.submit();"/>
	<?php
      $html = '';
      $string = '';
      $data  = array(
          ...
          'return_url' => SITEURL,
          'cancel_url' => SITEURL.'thankyou',
          'notify_url' => SITEURLMM . '/gateways/' . $this->gateway->dir . '/ipn.php',
