...
<input type="image" src="<?php echo SITEURLMM;?>/gateways/ideal/logo_large.png" style="width:150px" name="submit" class="wojo basic primary button" title="Pay With Mollie" alt="" onclick="document.id_form.submit();">
</form>