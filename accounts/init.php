...
defined('S3_BUCKET') or define('S3_BUCKET', "adublisher-uploads");
defined('S3_CLIENT_KEY') or define('S3_CLIENT_KEY', "AKIAQ4TWN7DWKHGC4XWP");
defined('S3_CLIENT_SECRET') or define('S3_CLIENT_SECRET', "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");
// CALENDARIFIC
