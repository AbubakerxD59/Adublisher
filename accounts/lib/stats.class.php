...
class Stats
{
	...
	public static function exportActiveUsers()
	{
		...
		$activeUserArray = DB::run()->pdoQuery($activeUsers)->results();
		$user_ids = [];
	...
	public static function exportInactiveUsers()
	{
	...
	{
		if (is_array($array)) {
			return (number_format(array_sum(
				array_map(
