      ...
      public function items_per_page()
      {
		  ...
		  if($this->items_total > $this->items_per_page) {
			  foreach ($ipp_array as $ipp_opt) {
				  ...
				  $html .= "<div class=\"item$active\" data-url=\"" . SITEURLMM . '/' . App::get('Core')->_urlParts . "\" data-pg=\"1\" data-ipp=\"$ipp_opt\" data-value=\"$ipp_opt\">$ipp_opt</div>";
			  }
		  }
		  $html .= "</div>";
		  $html .= "</div>";
      ...
      public function jump_menu()
      {
		  ...
		  if($this->num_pages >= 1) {
			  for ($i = 1; $i <= $this->num_pages; $i++) {
				  ...
				  $html .= "<div class=\"item\" data-url=\"" . SITEURLMM . '/' . App::get('Core')->_urlParts . "\" data-pg=\"idx\" data-ipp=\"$this->items_per_page\" data-value=\"$i\">$i</div>";
			  }
		  }
		  $html .= "</div>";
		  $html .= "</div>";
