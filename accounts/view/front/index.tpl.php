...
<div class="wojo-grid">
  <div class="wojo raised auto segment">
    ...
    <h2 class="center aligned" id="greetings"><?php echo Utility::sayHello();?></h2>
      ...
      <form id="admin_form" name="admin_form" method="post">
        <div class="wojo block fields">
          <div class="field">
            ...
            <input type="text" name="username" placeholder="<?php echo Lang::$word->M_EMAIL;?>">
          </div>
          <div class="field">
...
$(document).ready(function() {
    ...
    var welcome = "<?php echo Lang::$word->HI." "; ?>";
    if (curHr < 12) {
      welcome += "<?php echo Lang::$word->HI_M; ?>";
    } else if (curHr < 18) {
      welcome += "<?php  echo Lang::$word->HI_A; ?>";
    } else {
      welcome += "<?php echo Lang::$word->HI_E; ?>";
    }
