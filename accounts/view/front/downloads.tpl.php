    ...
    <div class="columns screen-50 tablet-50 mobile-100 phone-100">
      <div class="wojo fluid relaxed celled list">
        <div class="item align middle">
          <img src="<?php echo SITEURLMM;?>/assets/images/filetypes/<?php echo File::getFileType($row->name);?>" class="wojo small rounded shadow image">
          <div class="columns">
            <p class="header"><?php echo $row->alias;?></p>
            <span class="wojo small text"><?php echo Date::doDate("long_date", $row->created);?></span>
            <p class="wojo small text"><?php echo File::getSize($row->filesize);?> - <a href="<?php echo SITEURLMM;?>/controller.php?token=<?php echo $row->token;?>"><?php echo Lang::$word->DOWNLOAD;?></a>
            </p>
          </div>
        </div>
      </div>
