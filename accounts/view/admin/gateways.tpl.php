  ...
  <div class="wojo segment form">
    ...
    <div class="wojo fields">
      <div class="field">
        ...
        <input type="text" readonly value="<?php echo SITEURLMM.'/gateways/' . $this->data->dir . '/ipn.php';?>">
      </div>
    </div>
...
<div class="wojo cards screen-3 tablet-3 mobile-1">
  ...
  <div class="card">
    <div class="content dimmable <?php echo ($row->active == 0) ? "active" : "";?>" id="item_<?php echo $row->id;?>">
      ...
      <img src="<?php echo SITEURLMM;?>/gateways/<?php echo $row->dir;?>/logo_large.png" alt=""></a>
    </div>
