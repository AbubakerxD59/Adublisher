...
<div class="row gutters align middle">
  ...
  <div class="columns auto mobile-50 mobile-order-3">
    ...
    <?php 
      $filter = '';
      if(in_array('inactive', $this->segments)){
        $filter = '&filter=inactive';
      }
      elseif(in_array('active', $this->segments)){
    ...
    ?>
    <a href="<?php echo ADMINVIEW . '/helper.php?action=exportUsers'.$filter;?>" class="wojo small button"><?php echo Lang::$word->EXPORT;?></a>
  </div>
</div>
