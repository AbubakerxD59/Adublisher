...
<script type="text/javascript" src="<?php echo SITEURLMM; ?>/assets/editor/editor.js"></script>
<script type="text/javascript" src="<?php echo SITEURLMM; ?>/assets/editor/alignment.js"></script>
<script type="text/javascript" src="<?php echo SITEURLMM; ?>/assets/editor/fullscreen.js"></script>
<script type="text/javascript" src="<?php echo ADMINVIEW; ?>/js/master.js"></script>
<script type="text/javascript" src="<?php echo ADMINVIEW; ?>/js/custom.js"></script>
