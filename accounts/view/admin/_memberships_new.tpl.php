  ...
  <div class="wojo segment form">
        ...
        foreach ($this->features as $feature) {
          ...
          <div class="wojo fields align middle">
            ...
            <div class="field wide four">
              <div class="wojo action input">
                <input type="text" placeholder="Feature Limit" name="feature_limit[<?php echo $feature->id; ?>]">
              </div>
            </div>
            <div class="field wide two">
              <div class="wojo checkbox radio inline">
                <input name="unlimited[<?php echo $feature->id; ?>]" type="checkbox"
                  id="unlimited_<?php echo $feature->id; ?>">
    ...
    <div class="center aligned">
      ...
      <button type="button" data-action="processMembership" name="dosubmit"
        class="wojo primary button"><?php echo Lang::$word->MEM_SUB1; ?></button>
    </div>
  </div>
</form>