  ...
  <div class="wojo segment form">
    ...
    <div class="wojo fields">
      ...
      <div class="field three wide">
        ...
        <input placeholder="<?php echo Lang::$word->TO; ?>" name="mem_expire" type="text"
          value="<?php echo Date::doDate("MM/dd/yyyy", Date::NumberOfDays('+ 30 day')); ?>" readonly class="datepick">
      </div>
      <div class="field two wide">
        <label><?php echo Lang::$word->M_SUB15; ?></label>
        <div class="wojo fitted inline toggle checkbox">
    ...
    <div class="wojo fields">
      <div class="field">
        ...
        <div class="wojo checkbox radio fitted my-2">
      ...
      <div class="field">
        ...
        <div class="wojo checkbox radio fitted my-2">
          <input name="type" type="radio" value="writer" id="writer">
    ...
    <div class="center aligned">
      ...
      <button type="button" data-action="processUser" name="dosubmit"
        class="wojo primary button"><?php echo Lang::$word->M_TITLE5; ?></button>
    </div>
  </div>
</form>