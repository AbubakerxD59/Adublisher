...
<form method="post" id="wojo_form" name="wojo_form">
  <div class="wojo segment form">
    <div class="row gutters">
      <div class="columns screen-70 tablet-60 mobile-100 phone-100 padding">
        <div class="wojo fields align middle">
          ...
          <div class="field">
            <input type="text" placeholder="<?php echo Lang::$word->NAME; ?>" value="<?php echo $this->data->title; ?>"
              name="title">
          </div>
        </div>
        <div class="wojo fields align middle">
          ...
          <div class="field">
            <div class="wojo labeled input">
              ...
              <input type="text" placeholder="<?php echo Lang::$word->MEM_PRICE; ?>"
        ...
        <div class="wojo fields align middle">
          ...
          <div class="field">
            <div class="wojo action input">
              <input type="text" placeholder="<?php echo Lang::$word->MEM_DAYS; ?>"
        ...
        foreach ($this->features as $feature) {
          ...
          <div class="wojo fields align middle">
            ...
            <?php
            $sql = "select feature_limit, is_unlimited from package_to_features ptf where pid = " . $this->data->id . " and fid = " . $feature->id;
            $limit = Db::run()->pdoQuery($sql)->results();
            ?>
            <div class="field wide four">
              <div class="wojo action input">
                <input type="text" placeholder="Feature Limit" value="<?php echo $limit[0]->feature_limit; ?>"
                  name="feature_limit[<?php echo $feature->id; ?>]">
              </div>
            </div>
            <div class="field wide two">
              <div class="wojo checkbox radio inline">
                <input name="unlimited[<?php echo $feature->id; ?>]" type="checkbox"
                  id="unlimited_<?php echo $feature->id; ?>" <?php echo $limit[0]->is_unlimited ? "checked" : ""; ?>>
                <label for="unlimited_<?php echo $feature->id; ?>">Unlimited</label>
              </div>
            </div>
          </div>
          <?php
      ...
      <div class="columns screen-30 tablet-40 mobile-100 phone-100">
        <div class="wojo block fields">
          ...
          <div class="field">
            ...
            <textarea placehoder="<?php echo Lang::$word->DESCRIPTION; ?>"
              name="description"><?php echo $this->data->description; ?></textarea>
          </div>
        </div>
      </div>
    </div>
    <div class="center aligned">
      ...
      <button type="button" data-action="processMembership" name="dosubmit"
        class="wojo primary button"><?php echo Lang::$word->MEM_SUB2; ?></button>
    </div>
  </div>
