		...
		<div class="row">
			<div class="col-12">
				...
				<div class="card simple-card">
					<div class="card-body">
						<h2 class="text-center mt-2 m-b-0"> RSS to Pinterest posts<small><label class="label label-default text-success"> Experimental <i class="mdi mdi-help-circle-outline" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Our Rss Auto Feed feature is in beta version, if you find any bug please email it on info@adublisher.com"></i> </small></label></h2>
						<p class="text-center text-muted m-b-0">You can use the this service to auto-post an RSS feed to your Pinterest Board.<br> This is a huge time saver if you like to consistently post blog articles, news updates, and other things to Pinterest.</p>
											...
											<div class="card-body">
												<div class="row my-2">
													<div class="form-group col-md-4">
														...
														<label><b>Step 1-</b> Select Boards: <i class="mdi mdi-help-circle-outline" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="First step is to select board, your board must have published status on pinterest."></i>
														</label>
														<select id="boards" class=" form-control">
											...
											<div class="card-header ">
												...
												<div class="row">
													<div class="col-md-12 m-t-10 text-left">
														<b>Manage Scheduled Posts </b> <span id="pagenamedisplay"></span>: <i class="mdi mdi-help-circle-outline" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Here you can manage the existing posts on Boards. Select Board to load posts"></i>
											...
											<div class="card-body">
												<div class="col-md-12 text-center">
													<div class="alert alert-warning">
														<h3 class="text-warning"><i class="fa fa-exclamation-triangle"></i> Pinterest not connected </h3>
														<p><br>Connecting and authorizing Pinterest Boards is required, Click
															<a href="<?php echo $pinterest_login_url ?>">
															HERE </a> to connect right now. so Adublisher can publish posts you schedule/set.<br>
								...
								$(function() {
									...
									$("#boards").change(function() {
										...
										if (board != "") {
											...
											$.ajax({
												...
												url: "<?php echo SITEURL; ?>get_pinterest_rssscheduled",
												data: dataOBJ,
												dataType: "json",
									...
									$(".rssposting").click(function() {
										...
										if (board_id != "") {
											...
											$.ajax({
												type: "POST",
												url: "<?php echo SITEURL; ?>pinterest_rss_feed_onoff",
												data: dataOBJ,
												dataType: "json",
												success: function(response) {
													$("#loader").hide();
									...
									$(".delete_rss").click(function() {
										if ($("#rss_feed").val() != "") {
											swal({
												...
												$.ajax({
													type: "POST",
													url: "<?php echo SITEURL; ?>pinterest_rss_feed_engine",
													data: dataOBJ,
													dataType: "json",
													success: function(response) {
									...
									$("#submit_rss").click(function() {
										...
										// var publisher = $("#loggeduserid").val();
										if (board_id == "") {
											alertbox("Error", "Please Select Board first , and try again", "error");
											return false;
										}
										if (time_slots == "") {
										...
										if (board_id != "" && time_slots != "" && rss_url != "") {
											$("#preloader_ajax").show();
									...
									$(".chosen-select").change(function() {
										...
										if (board_id != "") {
											...
											$.ajax({
												type: "POST",
												url: "<?php echo SITEURL; ?>update_board_timeslots_rss",
												data: dataOBJ,
												dataType: "json",
												success: function(response) {},
												error: function() {}
									...
									$(document).on('click', '.deleteall', function() {
										...
										swal({
											...
											$.ajax({
												type: "POST",
												url: "<?php echo SITEURL; ?>delete_pinterest_rss_post_all",
												data: dataOBJ,
												dataType: "json",
												success: function(response) {
													$(".deleteall").hide();
									...
									$(document).on('click', '.shuffle', function() {
										...
										swal({
											...
											$.ajax({
												type: "POST",
												url: "<?php echo SITEURL; ?>shuffle_pinterest_rss_post_all",
												data: dataOBJ,
												dataType: "json",
												success: function(response) {
													$("#loader").hide();
									...
									$(document).on('click', '.delbulkone', function() {
										...
										swal({
											...
											$.ajax({
												type: "POST",
												url: "<?php echo SITEURL; ?>delete_pinterest_rss_post",
												data: dataOBJ,
												dataType: "json",
												success: function(response) {
													if (response.status) {
